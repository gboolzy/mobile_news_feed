                    ...
                    <>
                        <View style={{ position: 'relative', width: '100%' }}>
                            ...
                            <View style={styles.formContainer}>
                                ...
                                <UserTextInput label='Password' placeholder='Enter your password' secureTextEntry={true} marginBottom={10} />
                                <View style={{flexDirection:'row', justifyContent:'flex-end', marginBottom:30}}>
                                    <TextButton text='Forgot Password?' fontSize={14} onPress={()=>navigation.navigate("Signup")} />
                                </View>
                                

                                <View style={styles.buttonContainer}>
                                    <TextButton text='Sign Up' onPress={()=>navigation.navigate("Signup")} />
                                    <Button onPress={() => navigation.navigate("NewsFeed")} value='Login'/>
                                </View>
                            </View>
                        </View>
                    </>
